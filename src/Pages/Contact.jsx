          ...
          <div className="container mx-auto px-4">
            ...
            <div className="bg-gray-200 rounded-xl h-96 flex items-center justify-center">
              <div className="text-center">
                <MdLocationOn className="text-6xl text-[#FF8C42] mx-auto mb-4" />
                <h4 className="text-xl font-bold text-[#2E4A9E] mb-2">
                  Interactive Map
                </h4>
                <p className="text-gray-600">
                  Plot 123, Industrial Area, Jinja Road, Kampala
                </p>
                <button className="mt-4 bg-[#2E4A9E] text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                  Get Directions
                </button>
              </div>
            </div>
